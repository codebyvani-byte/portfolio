          ...
          <section className="flex flex-col md:flex-row items-center justify-between gap-10">
            <div className="flex-1">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed max-w-lg">
                Welcome to my digital nook. I’m an experienced Software Engineer
                passionate about building thoughtful, elegant, and user-focused
                experiences.
              </p>
            </div>
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-500 text-sm">
                    A responsive React + Tailwind portfolio website showcasing
                    faculties, events, and business
                  </p>
                </div>
              </div>
            </div>
          ...
          <section>
            ...
            <div className="space-y-8">
              <div className="flex justify-between items-start">
                <div>
                  <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 hover:text-blue-500 cursor-pointer transition-colors">
                    Top VS Code Extensions Every React & React Native Developers
                    MUST Know!
                  </h3>
                  <p className="text-gray-600 dark:text-gray-500 text-sm">
                    Ultimate list of VS Code extensions that save hours,makes
                    code cleaner and level up development workflow instantly.
                  </p>
                </div>
              </div>
            </div>
            <div className="space-y-8 mt-8">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-500 text-sm">
                    quick guide gets you up and running with Expo — no
